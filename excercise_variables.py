...
#Qsn 10 
##create variables for 35/7, 15^3, var2 % var1 and var2/var1, compare the results . (variable = var)
var_1 = 35/7
var_2 = 15**3
var_3 = 2 % 1 
var_4 = 2/1
...
#comparing the results (was not sure how to compare so l compared the results by size )
3375 > 5.0 > 2.0 > 0